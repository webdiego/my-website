...
export default function Description() {
  return (
    <div>
      <p>
        Hello, my name is <span className="font-bold">Diego</span> and I&apos;m an Italian web and
        mobile developer.
      </p>
      <p className="mt-2 ">
        ...
        <span className="font-bold"> New Zealand </span> in the past years ( I don&apos;t know where
