...
export let dataTech = [
  {
    ...
    icon: <Next className="tech-icon" />,
    name: "Next.js",
  },
  {
    background: "box--gradient platinum",
    icon: <Reactts className="tech-icon" />,
    name: "React.ts",
  },
  {
    background: "box--gradient platinum",
    icon: <Tailwind className="tech-icon" />,
    name: "Tailwind CSS",
  },
  {
    background: "box--gradient platinum",
    icon: <Supabase className="tech-icon text-red-200" />,
    name: "Supabase",
  },
  {
    background: "box--gradient platinum",
    icon: <Drizzle className="tech-icon" />,
    name: "Drizzle ORM",
  },
  {
    background: "box--gradient platinum",
    icon: <Prisma className="tech-icon" />,
    name: "Prisma",
  },

  {
    background: "box--gradient platinum",
    icon: <Sass className="tech-icon" />,
    name: "Sass",
  },
  {
    background: "box--gradient platinum",
    icon: <Firebase className="tech-icon" />,
    name: "Firebase",
  },
  {
    background: "box--gradient platinum",
    icon: <Sanity className="tech-icon" />,
    name: "Sanity",
  },
  {
    background: "box--gradient platinum",
